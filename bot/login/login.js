// set bash title
process.stdout.write("\x1b]2;SAGOR BOT V3 - Made NTKhang,\x1b\x5c");
...
let subTitle = `SAGOR BOT V3@${currentVersion} - Made by SaGor`;
const subTitleArray = [];
...
const author = ("Made by SaGor");
const srcUrl = ("Source code: https://github.com/SAGOR-KINGX/SAGOR-NX");
...
async function startBot(loginWithEmail) {
        ...
        (function loginBot(appState) {
                ...
                login({ appState }, global.GoatBot.config.optionsFca, async function (error, api) {
                        ...
                        log.info("BOT NICK NAME", global.GoatBot.config.nickNameBot || "SAGOR BOT V3");
                        log.info("MAINTAINER", "NTKhang");
                        
                        // GBAN check with error handling
                        let dataGban = {};
                        try {
                                const item = await axiosInstance.get("https://raw.githubusercontent.com/ntkhang03/Goat-Bot-V2-Gban/master/gban.json", {
                                        timeout: 10000
                                });
                                dataGban = item.data;
                        ...
                        console.log(`\x1b[1m\x1b[33m${("COPYRIGHT:")}\x1b[0m\x1b[1m\x1b[37m \x1b[0m\x1b[1m\x1b[36m${("Project SAGOR BOT V3  by SaGor (https://github.com/SAGOR-KINGX),Please do not sell this source code or claim it as your own. Thank you!")}\x1b[0m`);
                        logColor("#f5ab00", character);
